            ...
            <form ref="supplyForm" @submit.prevent="submitSupplyDAta" class="flex flex-col gap-5 items-center">
                ...
                <div v-for="supply in supplies" :key="supply.id"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input required type="text" v-model="supply.amount" class="p-2 focus:outline-orange-100 rounded-lg">
                    </div>
                    <div class="flex flex-col">
                        <label for="name">unit</label>
                        <input required type="text" v-model="supply.unit" class="p-2 focus:outline-orange-100 rounded-lg">
                    </div>
                    <div class="flex flex-col">
