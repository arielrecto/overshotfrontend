<template>
    <div class="m-0 p-0 h-auto my-10">
        <div id="default-carousel" class="relative" data-carousel="slide">
            ...
            <!-- Slider indicators -->
            <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2" v-for="image in images">
                <button type="button" class="w-3 h-3 rounded-full" aria-current="true" :aria-label="'Slide ' + image.id"
                    :data-carousel-slide-to="image.id - 1"></button>
            </div>
            <!-- Slider controls -->
            <button type="button"
