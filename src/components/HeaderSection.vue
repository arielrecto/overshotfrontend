<template>
    <div class="flex justify-center text-3xl font-semibold p-5 my-5">
        <h1 class="text-theme-accent">Featured Product</h1>
    </div>
    <header class="min-h-screen bg-auto bg-no-repeat bg-[length:450px_200px] 
            sm:bg-[length:760px_390px] 
            lg:bg-[length:1020px_500px] 
            xl:bg-auto snap-center" :style="'background-image:' + 'url(' + data.banner + ')'">
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div
                    class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-theme-accent">
                        <br class="hidden lg:inline-block"><span>{{ data.title }}</span>
                    </h1>
                    <p class="mb-8 leading-relaxed text-theme-secondary"><span>{{ data.description }}</span>
                    </p>
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 flex justify-center">
                    <img class="object-cover object-center rounded h-96 w-auto rounded-lg" :src="data.item" alt="hero">
                </div>
            </div>
        </section>
    </header>
